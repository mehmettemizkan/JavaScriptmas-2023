...
fireworksToggle.addEventListener("click", function () {
...
function startFireworks() {
        ...
        fireworksToggle.textContent = "Stop Fireworks";
}

function stopFireworks() {
        clearInterval(fireworksInterval);
        isFireworksActive = false;
        fireworksToggle.textContent = "Start Fireworks";
}
...
function animate() {
        ...
        ctx.clearRect(0, 0, canvas.width, canvas.height); // clear the background of the canva
